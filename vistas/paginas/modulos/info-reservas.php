			...
			<input type="text" class="form-control" value="Habitación <?php echo $reservas[$indice]["tipo"]." ".$reservas[$indice]["estilo"]; ?>" readonly>
				...
				<div class="form-group">
				  ...
				  <select class="form-control elegirPlan">
					...
					<option value="<?php echo $precioContinental;?>,Plan Continental">Plan Continental $MXN <?php echo number_format($precioContinental); ?> 1 día 1 noche</option>
					<option value="<?php echo $precioAmericano;?>,Plan Americano">Plan Americano $MXN <?php echo number_format($precioAmericano); ?> 1 día 1 noche</option>
					<option value="<?php echo $precioRomantico;?>,Plan Romantico">Plan Romántico $MXN <?php echo number_format($precioRomantico); ?> 1 día 1 noche</option>
					<option value="<?php echo $precioLunaDeMiel;?>,Plan Luna de Miel">Plan Luna de Miel $MXN<?php echo number_format($precioLunaDeMiel); ?> 1 día 1 noche</option>
					<option value="<?php echo $precioAventura;?>,Plan Aventura">Plan Aventura $MXN <?php echo number_format($precioAventura); ?> 1 día 1 noche</option>
					<option value="<?php echo $precioSPA;?>,Plan SPA">Plan SPA $MXN<?php echo number_format($precioSPA); ?> 1 día 1 noche</option>
				...
				<div class="row py-4">
					...
					<div class="col-12 col-lg-6 col-xl-7 text-center text-lg-left">
						...
						<h1 class="precioReserva">$MXN <span><?php echo number_format($precioContinental*$dias);?></span></h1>
					...
					<?php if (isset($_SESSION["validarSesion"])): ?>
						...
						<?php if ($_SESSION["validarSesion"] == "ok"): ?>
							...
							<a href="<?php echo $ruta;?>perfil" 
								...
								personas="2">
									<button type="button" class="btn btn-warning btn-lg w-100"><strong>PAGAR <br> RESERVA</strong> </button>
							</a>	
       			...
       			<?php foreach ($planes as $key => $value): ?>
					...
					<div class="col-12 col-md-6">
						...
						<figure class="center">
	       				...
	       				Temporada Baja: Plan Americano + $MXN <?php echo number_format($value["precio_baja"]); ?> <br>

	       				Temporada Alta: Plan Americano + $MXN <?php echo number_format($value["precio_alta"]); ?> 
