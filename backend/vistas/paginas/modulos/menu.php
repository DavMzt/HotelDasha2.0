<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="inicio" class="brand-link">
    ...
    <img src="vistas/img/plantilla/icono.png" class="brand-image img-circle elevation-3" style="opacity: .8">

    <span class="brand-text font-weight-light text-center" style="width: 150px">HOTEL DASHA</span>
